   ...
   <lowest number="123">
    ...
    def test_multi_datasets(self):
        ...
        expected = {
            ...
            "2": [
                ...
                {"author": "Randall, Cynthia", "price": "4.95", "title": "Lover Birds"},
                {"author": "Thurman, Paula", "price": "4.95", "title": "Splish Splash"},
                {
                    "author": "Knorr, Stefan",
                    "price": "4.95",
                    "title": "Creepy Crawlies",
    ...
    def test_no_processes_supplied(self):
        ...
        with self.assertRaisesRegexp(
            Exception, "process definition not supplied as argument"
        ):
    ...
    def test_dispatch_all(self):
        ...
        output = parse_using_profile(
            self.xml,
            profile,
            dispatch={"__generic__": {"coderef": dataset1, "counter": 100}},
        )
        self.maxDiff = None
    ...
    def test_dispatch_all_2s(self):
        ...
        output = parse_using_profile(
            ...
            profile,
            dispatch={
                "1": {"coderef": dataset1, "counter": 2},
                "2": {"coderef": dataset2, "counter": 2},
            },
        )
    ...
    def test_global_values(self):
        ...
        output = parse_using_profile(
            self.xml, profile, global_values={"location": "Chorleywood"}
        )
        self.maxDiff = None
        self.assertDictEqual(expected, output)
